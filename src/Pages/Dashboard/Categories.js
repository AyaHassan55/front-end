      ...
      {loading ? (
        (
          <div className="text-center py-5">
            ...
            <p className="mt-3 text-secondary fw-semibold">Loading categories...</p>
          </div>
        )
      ) :
        users.length === 0 ? (
          <div className="empty-state text-center">
            <FontAwesomeIcon icon={faFolderOpen} size="3x" color="#ddd" />
            <h5>No Categories Found</h5>
            <p>It looks like there are no categories in the system. Please add some categories.</p>
          </div>
        ) :
